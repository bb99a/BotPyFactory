...
if __name__ == "__main__":
    ...
    batch_rename_files(directory_path, naming_option=naming_option, new_extension=new_extension_input, regex_pattern=regex_pattern, replacement_string=replacement_string)
